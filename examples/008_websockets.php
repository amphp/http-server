 ...
 * To run:
 *
 * $ bin/aerys -c examples/008_websockets.php
 *
...
require_once __DIR__ . '/support/008_includes.php';

$myApp = (new Aerys\Host)
    ->setPort(1337)
    ->addWebsocketRoute('/echo', 'ExampleWebsocket')
    ->setRoot(__DIR__ . '/support/docroot/websockets')
;
