...
class WebsocketHandler {
    ...
    /**
     * Some browsers (I'm looking at you, Firefox) send multiple connection headers e.g. 
     * "Connection: keep-alive, Upgrade" so it's necessary to check for the upgrade value as part
